...
def main():
    ...
    for N_WAY in N_WAY_LIST:
        for N_SHOT in N_SHOT_LIST:
            ...
            # Variables para calcular media de tiempos de entrenamiento
            total_train_time = 0.0
            
            for epoch in range(MAX_EPOCHS):
                # --- TIME MEASUREMENT START (EPOCH) ---
                timer.start()
                ...
                # --- TIME MEASUREMENT STOP (EPOCH) ---
                timer.stop()
                epoch_duration_sec = timer.get_time_sec()
                ...
                if (epoch + 1) % 5 == 0 or epoch == 0:
                    ...
                    print(f"Epoch {epoch+1}/{MAX_EPOCHS} | Time: {epoch_duration_sec:.1f}s")
            ...
            # Guardamos métricas finales en el resumen para tablas comparativas
            wandb.summary["best_val_acc"] = best_val_acc
            wandb.summary["total_training_time_min"] = total_train_time / 60.0
